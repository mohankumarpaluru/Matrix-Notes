        ...
        {author && (
          <div className="flex shrink-0 mr-3">
            <a className="relative" href="#0">
              ...
              <img className="relative rounded-full" src='https://cdn.jsdelivr.net/gh/mohankumarpaluru/Matrix-Notes@main/public/assets/blog/authors/mkp.jpg' width="32" height="32" alt="Author" />
            </a>
          </div>
        )}
        <div>
